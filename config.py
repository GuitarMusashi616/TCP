...
ATTEMPTS_UNTIL_EXIT = 1000  # Retries waiting for a response ATTEMPTS_UNTIL_EXIT times
MAX_DATA_SIZE = 1448        # The maximum number of bytes that can be attached to a header